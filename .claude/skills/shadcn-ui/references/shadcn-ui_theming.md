...
- **Neutral** - Comprehensive CSS variable definitions for neutral color palette across light and dark modes.
- **Stone** - Comprehensive CSS variable definitions for stone color palette across light and dark modes.
- **Zinc** - Comprehensive CSS variable definitions for zinc color palette across light and dark modes.
- **Gray** - Comprehensive CSS variable definitions for gray color palette across light and dark modes.
- **Slate** - Comprehensive CSS variable definitions for slate color palette across light and dark modes.
