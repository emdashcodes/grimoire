---
title: shell
source_url: https://www.electronjs.org/docs/latest/api/shell
---
...
](/docs/latest/breaking-changes#api-changed-shellopenitem-is-now-shellopenpath)
...
Added `activate` option.

None

Added `workingDirectory` option.

[

\>=24.0.0

](https://github.com/electron/electron/pull/37139)
...
*   `options` Object (optional)
    ...
    *   `logUsage` boolean (optional) _Windows_ - Indicates a user initiated launch that enables tracking of frequently used programs and other behaviors. The default is `false`.
...
](https://github.com/electron/electron/pull/25114)
