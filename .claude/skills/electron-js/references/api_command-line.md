...
source_url: https://www.electronjs.org/docs/latest/api/command-line
---
...
For more information on what kinds of flags and switches you can use, check out the [Command Line Switches](/docs/latest/api/command-line-switches) document.
