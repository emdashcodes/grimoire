---
title: Session Modes
source_url: https://agentclientprotocol.com/protocol/session-modes
---
...
> **Note:** You can now use [Session Config Options](./session-config-options). Dedicated session mode methods will be removed in a future version of the protocol. Until then, you can offer both to clients for backwards compatibility.
