---
title: Kotlin
source_url: https://agentclientprotocol.com/libraries/kotlin
---
...
The [kotlin-sdk](https://github.com/agentclientprotocol/kotlin-sdk) provides implementations of both sides of the Agent Client Protocol that you can use to build your own agent server or client.
