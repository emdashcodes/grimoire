---
title: TypeScript
source_url: https://agentclientprotocol.com/libraries/typescript
---
...
The [@agentclientprotocol/sdk](https://www.npmjs.com/package/@agentclientprotocol/sdk) npm package provides implementations of both sides of the Agent Client Protocol that you can use to build your own agent server or client.
